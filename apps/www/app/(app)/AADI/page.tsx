    ...
    return (
        <>
            ...
            <div className="bg-black text-white py-4 px-6 text-center">
                <Link href="/hero" className="text-sm font-mono tracking-wider hover:text-orange-400 transition-colors">
                    ← EXPERIENCE THE AI HERO
                </Link>
            </div>

            {/* Section 1 - Features & Testimonials */}
            {/* Section 2 - Features & Testimonials */}
            <section className="bg-background overflow-hidden border-b pb-4 md:pb-20">
                <div className="relative px-4 pt-5 lg:mb-16 lg:pt-8 2xl:mx-auto 2xl:max-w-7xl">
                ...
                <Link
                    ...
                    className="mx-auto block w-fit mt-8"
                    target="_blank"
            ...
            <div className="pt-24">
                <div className="mx-auto px-4 lg:px-6 2xl:max-w-7xl mb-8">
                    <div className="text-center">
                        <span className="bg-gray-100 dark:bg-gray-900/30 text-gray-600 dark:text-gray-300 px-2 py-1 rounded-md font-mono text-xs">05</span>
                        <span className="text-gray-500 dark:text-gray-400 text-sm ml-2">Footer & Navigation</span>
                    </div>
                </div>
                <SiteFooter />
            </div>
