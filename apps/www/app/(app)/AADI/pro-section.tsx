                    ...
                    <div className="mx-auto px-4 lg:px-6 2xl:max-w-7xl">
                        <div className="mx-auto lg:w-1/2">
                            <div className="max-w-xl max-md:mx-auto max-md:text-center">
                                <span className="bg-linear-to-r mb-6 block from-emerald-600 to-indigo-600 bg-clip-text text-transparent dark:from-emerald-400 dark:to-indigo-400">
                                    <span className="bg-gradient-to-r from-emerald-100 to-indigo-100 dark:from-emerald-900/30 dark:to-indigo-900/30 text-emerald-700 dark:text-emerald-300 px-2 py-1 rounded-md font-mono text-xs mr-2">04</span>
                                    Pro
                                </span>
