            ...
            <main>
                <section className="pt-16 md:pt-32">
                    ...
                    <div className="mx-auto max-w-5xl px-6 pt-32 lg:px-0">
                        <div className="mx-auto max-w-2xl space-y-6 text-center">
                            <div className="mb-4">
                                <span className="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 px-2 py-1 rounded-md font-mono text-xs">01</span>
                                <span className="text-blue-500 dark:text-blue-400 text-sm ml-2">Hero</span>
                            </div>
                ...
                <section className="py-16 md:py-32">
                    <div className="mx-auto max-w-5xl space-y-16 px-6 md:space-y-32">
                        ...
                        <div className="mx-auto grid max-w-lg gap-6 md:gap-12">
                            <div>
                                <span className="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-300 px-2 py-1 rounded-md font-mono text-xs mr-2">02</span>
                                <span className="text-green-500 dark:text-green-400 text-sm">Our Mission</span>
                            </div>
                ...
                <section className="px-6 py-16 md:py-32">
                    <div className="mx-auto max-w-lg">
                        <div className="mb-4">
                            <span className="bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-300 px-2 py-1 rounded-md font-mono text-xs mr-2">03</span>
                            <span className="text-purple-500 dark:text-purple-400 text-sm">Our Story</span>
                        </div>
                ...
                <section className="py-16 md:py-32">
                    <div className="mx-auto max-w-lg px-6 lg:px-0">
                        <div className="mb-4">
                            <span className="bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-300 px-2 py-1 rounded-md font-mono text-xs mr-2">04</span>
                            <span className="text-orange-500 dark:text-orange-400 text-sm">Our Team</span>
                        </div>
