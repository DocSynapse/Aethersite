            ...
            <section className="py-32">
                <div className="mx-auto max-w-5xl px-6 lg:px-0">
                    <div className="mb-8 text-center">
                        ...
                        <span className="text-blue-500 dark:text-blue-400 text-sm ml-2">Contact Information</span>
                    </div>
                    ...
                    <form
                        ...
                        <div className="text-center mb-8">
                            <span className="bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-300 px-2 py-1 rounded-md font-mono text-xs">02</span>
                            <span className="text-green-500 dark:text-green-400 text-sm ml-2">Contact Form</span>
                        </div>
