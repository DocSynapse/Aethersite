                    ...
                    <div className="mx-auto max-w-5xl px-6 lg:px-0">
                        <div className="mx-auto max-w-2xl space-y-6 text-center">
                            <div className="mb-4">
                                ...
                                <span className="text-blue-500 dark:text-blue-400 text-sm ml-2">Pricing Plans</span>
                            </div>
                ...
                <section className="py-16">
                    <div className="mx-auto max-w-5xl px-6 lg:px-0">
                        <div className="mb-8 text-center">
                            ...
                            <span className="text-green-500 dark:text-green-400 text-sm ml-2">Comparison Table</span>
                        </div>
