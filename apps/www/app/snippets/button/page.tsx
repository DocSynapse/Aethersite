        ...
        <div className="*:has-[[data-state=open]]:bg-muted/25 *:hover:bg-muted/25 grid grid-cols-2 divide-x divide-y divide-dashed *:relative *:flex *:aspect-square *:items-center *:justify-center *:p-12 sm:grid-cols-2 lg:grid-cols-3 lg:*:aspect-video 2xl:mx-auto 2xl:max-w-7xl">
            <div className="group">
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        ...
                        {...formatButtonVariantCode('default', 'from-primary to-primary/85 text-primary-foreground border border-zinc-950/25 bg-gradient-to-t shadow-md shadow-zinc-950/20 ring-1 ring-inset ring-white/20 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 dark:border-white/20 dark:ring-transparent')}
                    />
                </div>
            </div>
            <div className="group">
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('default')}
                        {...formatButtonVariantCode('default', 'from-primary/85 to-primary text-primary-foreground inset-shadow-2xs inset-shadow-white/25 bg-linear-to-b dark:from-primary/75 dark:bg-linear-to-t border border-zinc-950/35 shadow-md shadow-zinc-950/20 ring-0 transition-[filter] duration-200 hover:brightness-110 active:brightness-95 dark:border-0 dark:border-zinc-950/50')}
                    />
                </div>
            </div>
            <div className="group">
            ...
            <div className="group">
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('default')}
                        {...formatButtonVariantCode('default', 'bg-linear-to-b **:[text-shadow:0_1px_0_var(--color-primary)] border-primary from-primary/80 to-primary dark:from-primary dark:to-primary/80 text-primary-foreground dark:border-primary border text-sm shadow-md shadow-zinc-950/30 ring ring-inset ring-white/20 transition-[filter] duration-200 hover:brightness-125 active:brightness-95')}
                    />
                </div>
            </div>
            <div className="group">
            ...
            <div className="group">
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('default')}
                        {...formatButtonVariantCode('default', 'active:scale-98 border-primary bg-primary/75 text-primary-foreground hover:bg-primary/85 dark:bg-primary/90 dark:border-primary dark:hover:bg-primary border border-b-2 shadow-md shadow-zinc-950/20 ring ring-inset ring-white/15 transition-[filter,scale,background] duration-200 hover:brightness-110 dark:ring-transparent')}
                    />
                </div>
            </div>
            <div
                ...
                <Button
                    variant="outline"
                    className="bg-linear-to-b before:bg-background hover:before:bg-muted relative border-none from-zinc-200 from-75% to-zinc-400/65 shadow-sm shadow-zinc-950/10 ring-0 *:relative before:absolute before:inset-px before:rounded-[calc(var(--btn-radius)-1px)] dark:from-zinc-800 dark:to-zinc-800">
                    <span className="relative">Outline</span>
                </Button>

                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('outline')}
                        {...formatButtonVariantCode('outline', 'bg-linear-to-b before:bg-background hover:before:bg-muted relative border-none from-zinc-200 from-75% to-zinc-400/65 shadow-sm shadow-zinc-950/10 *:relative before:absolute before:inset-px before:rounded-[calc(var(--btn-radius)-1px)] dark:from-zinc-800 dark:to-zinc-800')}
                    />
                </div>
            </div>
            <div className="group">
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('outline')}
                        {...formatButtonVariantCode('outline', 'bg-muted hover:bg-background dark:bg-muted/25 dark:hover:bg-muted/50 dark:border-border inset-shadow-2xs inset-shadow-white dark:inset-shadow-transparent relative flex border border-zinc-300 shadow-sm shadow-zinc-950/10 ring-0 duration-150')}
                    />
                </div>
            </div>
            <div className="group">
                <Button
                    variant="outline"
                    className="shadow-xs bg-linear-to-t hover:to-muted/50 to-background from-muted dark:from-muted/50 dark:border-border border border-zinc-300 shadow-zinc-950/10 ring-0 duration-200">
                    Outline
                </Button>
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('outline')}
                        {...formatButtonVariantCode('outline', 'shadow-xs bg-linear-to-t hover:to-muted to-background from-muted dark:from-muted/50 dark:border-border border border-zinc-300 shadow-zinc-950/10 duration-200')}
                    />
                </div>
            </div>
            <div className="group">
                <Button
                    variant="outline"
                    className="bg-background hover:bg-muted/50 dark:ring-input border-input/50 dark:border-input relative border-b-2 shadow-sm shadow-zinc-950/15 ring-1 ring-zinc-300">
                    <span className="realtive">Outline</span>
                </Button>
                ...
                <div className={actionClasses}>
                    <SnippetPreview
                        description={getButtonVariantDescription('outline')}
                        {...formatButtonVariantCode('outline', 'bg-background hover:bg-muted/50 dark:ring-input border-input/50 dark:border-input relative border-b-2 shadow-sm shadow-zinc-950/15 ring-1 ring-zinc-300')}
                    />
                </div>
            </div>
