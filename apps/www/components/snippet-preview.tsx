'use client'
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from '@docsynapse/core/ui/dialog'
            ...
            <DialogContent className="!max-w-xl">
                ...
                <div className="relative grid w-full">
                    <Button
                        ...
                        size="icon"
                        variant="ghost"
                        className="absolute right-0.5 top-0.5 size-8 rounded-md text-white/75 hover:bg-white/10 hover:text-white"
                    ...
                    <CodeBlock
                        code={displayedCode}
                        lang="tsx"
                        className="[&_pre]:min-h-auto [&_pre]:rounded-(--radius) [&_pre]:max-w-[33rem]! !w-full [&_pre]:border-none dark:[&_pre]:!bg-zinc-900"
                    />
                </div>
            </DialogContent>
        </Dialog>
